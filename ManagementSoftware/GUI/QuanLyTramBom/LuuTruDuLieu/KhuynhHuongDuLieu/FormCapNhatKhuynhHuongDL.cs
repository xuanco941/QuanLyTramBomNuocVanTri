...
{
    public partial class FormCapNhatKhuynhHuongDL : Form
    {
        public FormCapNhatKhuynhHuongDL(string name)
        {
            InitializeComponent();
        ...
        private void FormCapNhatKhuynhHuongDL_Load(object sender, EventArgs e)
        {
            List<XuHuongVaTinHieu>? listXuHuong = DALKhuynhHuong.GetAListXuHuongFromName(comboBoxTenKH.Text);
            AutoFillAllField(listXuHuong);
        }
