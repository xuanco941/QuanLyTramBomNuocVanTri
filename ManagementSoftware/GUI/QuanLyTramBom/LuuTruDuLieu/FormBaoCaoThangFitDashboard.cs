                    ...
                    if (sfd.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                            using (var workBook = new XLWorkbook())
                            {
                                ...
                                if (z == 0)
                                {
                                    ws.Cell("B2").Value = "CP2 BÁO CÁO THÁNG";
                                ...
                                else if (z == 1)
                                {
                                    ...
                                    ws.Range(ws.Cell("B2"), ws.Cell("C2")).Value = "CP2 BÁO CÁO THÁNG";
                                ...
                                {
                                    ws.Cell("C2").Value = "CP2 BÁO CÁO THÁNG";
                                ...
                                else if (z == 3)
                                {
                                    ...
                                    ws.Range(ws.Cell("C2"), ws.Cell("D2")).Value = "CP2 BÁO CÁO THÁNG";
                                ...
                                ws.Row(7).Height = 40;
                                ws.Row(7).AdjustToContents();

                                ws.Cell("A5").Value = d.ToString("MM/yyyy");
                                ws.Cell("A5").Style.NumberFormat.Format = "MM/yyyy";
                                ...
                                ws.Range("A8:G40").Style.Font.FontSize = 14;
                                ws.Range("A8:G40").Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
