...
namespace ManagementSoftware.PLCConvertTypeData.Types
{
    public class Double
    {
        ...
        public static byte[] DToByteArray(int value)
        {
        ...
        public static byte[] DWToByteArray(uint value)
        {
            byte[] bytes = new byte[4];
            int x = 4;
            long valLong = value;
        ...
        #endregion
        #region FromDWord
        public double FromDWord(int value)
        {
            byte[] b = DToByteArray(value);
        ...
        public static byte[] ToByteArray(double value)
        {
            ...
            if (wert != 0f)
            {
                ...
                {
                    if (!(wert - Math.Pow(2, -cnt) < 0))
                    {
                        wert = wert - Math.Pow(2, -cnt);
                        binString += "1";
                    }
                    else
                        binString += "0";
