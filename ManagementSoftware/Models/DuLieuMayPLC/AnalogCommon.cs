...
namespace ManagementSoftware.Models.DuLieuMayPLC
{
    public class AnalogCommon
    {
        ...
        public static Analog D10002 = new Analog("D10002", "CP2_AI008C00", "DPS", NhomBom.Chung, "Dòng điện nguồn đến số 1", "A", 200, 0);
        public static Analog D10004 = new Analog("D10004", "CP2_AI009C00", "DPS", NhomBom.Chung, "Điện áp nguồn đến số 2", "KV", 9, 0);
        public static Analog D10006 = new Analog("D10006", "CP2_AI010C00", "DPS", NhomBom.Chung, "Dòng điện nguồn đến số 2", "A", 200, 0);
        public static Analog D10008 = new Analog("D10008", "CP2_AI011C00", "DPS", NhomBom.Chung, "Mực nước kênh hút", "m", 14, 0);
        public static Analog D10010 = new Analog("D10010", "CP2_AI012C00", "DPS", NhomBom.Chung, "Mực nước kênh xả", "m", 20, 0);
        public static Analog D10016 = new Analog("D10016", "CP2_AI101C00", "DPS", NhomBom.Bom1, "Nhiệt độ cuộn dây pha U ĐC bơm 1", "℃", 150, 0);
        public static Analog D10018 = new Analog("D10018", "CP2_AI102C00", "DPS", NhomBom.Bom1, "Nhiệt độ cuộn dây pha V ĐC bơm 1", "℃", 150, 0);
        public static Analog D10020 = new Analog("D10020", "CP2_AI103C00", "DPS", NhomBom.Bom1, "Nhiệt độ cuộn dây pha W ĐC bơm 1", "℃", 150, 0);
        public static Analog D10022 = new Analog("D10022", "CP2_AI104C00", "DPS", NhomBom.Bom1, "Dòng điện động cơ bơm số 1", "A", 100, 0);
        public static Analog D10024 = new Analog("D10024", "CP2_AI105C00", "DPS", NhomBom.Bom1, "Độ mở van xả bơm số 1", "%", 100, 0);
        public static Analog D10092 = new Analog("D10092", "CP2_AI109C00", "DPS", NhomBom.Bom1, "Tổng số giờ bơm 1 chạy", "Min", 9999999, 0);
        public static Analog D10030 = new Analog("D10030", "CP2_AI201C00", "DPS", NhomBom.Bom2, "Nhiệt độ cuộn dây pha U ĐC bơm 2", "℃", 150, 0);
        public static Analog D10032 = new Analog("D10032", "CP2_AI202C00", "DPS", NhomBom.Bom2, "Nhiệt độ cuộn dây pha V ĐC bơm 2", "℃", 150, 0);
        public static Analog D10034 = new Analog("D10034", "CP2_AI203C00", "DPS", NhomBom.Bom2, "Nhiệt độ cuộn dây pha W ĐC bơm 2", "℃", 150, 0);
